...
RSSアイテムは設定により、登録されているカテゴリ別または全てまとめて表示されます。それ以外の操作についてはRSSリーダーの最大化と同じです。最大化時の操作については、ユーザーガイドの<a name="rss-reader-gadget.md#maximize">RSSリーダーの最大化</a>を参照ください。
